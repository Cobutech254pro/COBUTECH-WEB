...
const handleForgotPasswordReset = require('./Cobutechauth/cobuir');
const app = express();
...
app.get('/forgot-password', (req, res) => {
    res.sendFile(path.join(__dirname, '../Cobutech/Cobutechhtml/cobu.html'));
});
app.get('/signup', (req, res) => {
    res.sendFile(path.join(__dirname, '../Cobutech/Cobutechhtml/cobus.html')); 
});
