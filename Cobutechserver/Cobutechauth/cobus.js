...
const handleSignup = (app) => {
    app.post('/api/auth/signup', async (req, res) => {
        ...
        try {
            ...
            const newUserResult = await db.query(
                'INSERT INTO users (username, email, password_hash, verification_code, verification_code_expiry, registration_date, verification_token) VALUES ($1, $2, $3, $4, $5, NOW(), $6) RETURNING user_id, username, emai',
